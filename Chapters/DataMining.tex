...
\begin{itemize}
    ...
    \begin{figure}[ht!]
        \centering
        \includegraphics[scale=0.4]{images/ETL_dict_based_techniques_2.png}
    ...
    \begin{itemize}
        \item \textit{Approximate join} (DESCRIZIONE E IMMAGINE)
        \item \textit{Similary functions} (DESCRIZIONE E IMMAGINE).
    \end{itemize}
    \item \textbf{Ad-hoc algorithms:} custom algorithms based on specific business rules. (IMMAGINE)
\end{itemize}
