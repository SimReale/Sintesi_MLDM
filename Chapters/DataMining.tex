...
\begin{itemize}
    ...
    \begin{figure}[ht!]
        \centering
        \includegraphics[scale=0.6]{images/DFM_descriptive_attributes.png}
    \end{figure}
...
A star schema is characterized by fact tables and dimension tables. A fact table contains all the measures and descriptive attributes linked to a act. A dimensional table is created for each dimension and it includes all the hierarchy attributes.
